...
public class MyColorBlobDetector {
    ...
    public MyColorBlobDetector(Scalar colorToDetect)
    {
        double minH = (colorToDetect.val[0] >= mColorRadius.val[0]) ? colorToDetect.val[0]-mColorRadius.val[0] : 0;
        double maxH = (colorToDetect.val[0]+mColorRadius.val[0] <= 255) ? colorToDetect.val[0]+mColorRadius.val[0] : 255;

        mLowerBound.val[0] = minH;
        mUpperBound.val[0] = maxH;

        mLowerBound.val[1] = colorToDetect.val[1] - mColorRadius.val[1];
        mUpperBound.val[1] = colorToDetect.val[1] + mColorRadius.val[1];

        mLowerBound.val[2] = colorToDetect.val[2] - mColorRadius.val[2];
        mUpperBound.val[2] = colorToDetect.val[2] + mColorRadius.val[2];
